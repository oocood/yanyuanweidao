...
class Navigate {
	...
	int count;
	void add_node() {
        // FILE* file_ptr = freopen("./node.txt", "r", stdin);
        FILE* file_ptr = freopen("E:\\Yanyuanweidao\\Yanyuanweidao\\yanyuanweidao\\navigate\\node.txt", "r", stdin);
        // if(file_ptr==nullptr) cout<<"null pointer"<<endl; //测试是否正常打开
        // else cout<<"success open file"<<endl;
		scanf("%d", &n);
	...
	void add_edge() {
        // FILE* file_ptr1=freopen("edge.txt", "r", stdin);
        FILE* file_ptr1=freopen("E:\\Yanyuanweidao\\Yanyuanweidao\\yanyuanweidao\\navigate\\edge.txt", "r", stdin);
        // if(file_ptr1==nullptr) cout<<"null pointer1"<<endl;
        // else cout<<"success open file1"<<endl;
		len = 0;
		int m, x, y;
		scanf("%d", &m);
